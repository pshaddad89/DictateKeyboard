...
object GlideDictionaryCatalog {
    ...
    val all: List<GlideDict> = listOf(
        ...
        GlideDict("is", "Icelandic · Íslenska", "$REL/is.json", 1606704, "31e1ac9009e201a0e68f64468d41fa3ff046688fdc21aed681233209520311a3"),
        ...
        GlideDict("ka", "Georgian · ქართული", "$REL/ka.json", 3357119, "77d2e11bfd46d74ca13cade97e265e6005fdff8e181105316c9d58d9d0a902bd"),
